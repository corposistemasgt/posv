		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({ 
		        url: '../ajax/buscar_ruta.php?action=ajax&page=' + page + '&q=' + q,
		...
		function obtener_datos(id) {
		    var nombre_cliente = $("#ruta" + id).val();
