$(document).ready(function() {
    load();
    $("#f_resultado").load("../ajax/incrementa_fact_cot_escuela.php");
    $("#datos_factura").load();
    $("#barcode").focus();
    loadmodal(1);
});
...
function load() {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/cargar_cotizacion_pendiente.php",
        data: "idcoti=" + idcoti ,
        beforeSend: function(objeto) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/cargar_cotizacion_pendiente_cliente.php",
        data: "idcoti=" + idcoti ,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
            if(idcoti>0)
            {
                ...
                $('#nombre_cliente').val(obj.scliente);
                $('#tel1').val(obj.nit);
                $('#factura').val(obj.factura);
            }
...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalcot_escuela.php",
        data: "id=" + id + "&precio_venta=" + precio_venta + "&cantidad=" + cantidad + "&operacion=" + 2+ "&idcoti=" + idcoti,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
...
function eliminar(id) {
    ...
    $.ajax({
        type: "GET",
        url: "../ajax/agregar_tmp_modalcot_escuela.php",
        data: "id=" + id + "&idcotizacion=" + idcoti,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
