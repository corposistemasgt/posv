...
$sql            = mysqli_query($conexion, "select * from productos where id_producto='$idproducto'");
$rw             = mysqli_fetch_array($sql);
$nombre         = $rw['nombre_producto'];
$image_path     = $rw['image_path'];
$sentencia = "select * from stock where id_producto_stock='$idproducto' and id_sucursal_stock = '$idsucursal'";
$sql2            = mysqli_query($conexion, $sentencia);
$rw2             = mysqli_fetch_array($sql2);
$stock          = $rw2['cantidad_stock'];
?>
<div class="row">
	<div class="col-lg-3">
