				...
				<div class="modal-body">
					<form class="form-horizontal" method="post" id="editar_cliente" name="editar_cliente">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="estado" class="control-label">Se permite Credito?:</label>
									<select class="form-control" id="mod_credito" name="mod_credito" required>
										<option value="">-- Selecciona --</option>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="estado" class="control-label">Se permite Credito?:</label>
									<input type="text" class="form-control" id="mod_limite_credito" name="mod_limite_credito" autocomplete="off" required>
								</div>
							</div>
							<div class="col-md-4">
							<div class="form-group">
									<label for="estado" class="control-label">RUTA:</label>
									<select class="form-control" id="mod_ruta" name="mod_ruta" required>
