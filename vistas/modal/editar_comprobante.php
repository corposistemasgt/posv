						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control " id="nombre2" name="nombre2"  autocomplete="off" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control " id="serie2" name="serie2"  autocomplete="off" required>
								</div>
							</div>
						</div>
						<div class="row">
