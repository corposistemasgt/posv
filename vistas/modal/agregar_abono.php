        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="corre" class="control-label">Correlativo:</label>
                  <input type="text" class="form-control" id="corre" name="corre" autocomplete="off" pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8" required autofocus>
                </div>
              </div>
            </div>
            <div class="row">
