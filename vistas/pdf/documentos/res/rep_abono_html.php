...
?>
  ...
  <table cellpadding='4' cellspacing='0' border='0'>
    <tr>
      <th style="width: 15%" class='midnight-blue'>Factura</th>
      <th style="width: 15%" class='midnight-blue'>Correlativo</th>
    ...
    <tr>
      ...
      <td style="height:3%;text-align: center;"><?php echo $corre; ?></td>
