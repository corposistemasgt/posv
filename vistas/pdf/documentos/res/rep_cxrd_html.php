...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' style="font-size: 13px; font-family: helvetica">
  ...
  <table style="width: 100%; border: solid 0px black;" cellspacing=0>
    <tr>
      ...
      <td style="text-align: center;    width: 34%;font-size: 14px; font-weight: bold">Estado de cuenta</td>
  ...
  <table class="table-bordered" style="width:100%;">
    <tr class="midnight-blue">
      <th style="width:10%;">Factura Nº</th>
      <th style="width:10%;">Fecha</th>
      <th style="width:10%;">Estado</th>
      <th style="width:10%;">Dias de Cr.</th>
...
while ($row = mysqli_fetch_array($query)) {
    ...
    ?>
      <tr>
        ...
        <td><?php echo $diasr; ?></td>  
        <td><?php echo $simbolo_moneda . '' . number_format($monto, 2) ?></td> 
        <td><?php echo $simbolo_moneda . '' . number_format($saldo, 2) ?></td>
        <td><?php echo $simbolo_moneda . '' . number_format($ganancia, 2) ?></td>
        </tr>
      <?php
}
...
?>
    <tr>
      <td style='text-align:right;border-top:3px solid #2c3e50;padding:4px;padding-top:4px;font-size:14px' colspan="8"><?php echo $simbolo_moneda . '' . number_format($sumador_total, 2) ?></td>
    </tr>
  </table>
  <page_footer>
