...
?>
  ...
  <table class="table-bordered" style="width:100%;">
    <tr class="midnight-blue">
      ...
      <th style="width:7%;">Precio V. </th>
      <th style="width:7%;">Precio M. </th>
      <!--<th style="width:7%;">Precio E. </th>-->
      <th style="width:9%;">Total Costo</th>
    </tr>
    <?php
$sumador_total  = 0;
$simbolo_moneda = "Q";
...
<td><?php echo "  ";?></td>
<td><?php echo "  ";?></td>
<td style='text-align:right; border-top:3p solid #2c3e50; padding:4px:padding-top:4px;font-size:14px'><?php echo "Total: ";?></td>

  <td style='text-align:right;border-top:3px solid #2c3e50;padding:4px;padding-top:4px;font-size:14px' colspan="1"><?php echo $simbolo_moneda . '' . number_format($sumador_total, 2) ?></td>
</tr>
</table>
<page_footer>
