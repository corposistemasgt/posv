...
$dir   = $rw_factura['factura_direccion_cliente'];
...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' footer='page'>
    <table width="175px" style="font-size:12px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" border="0" >
        ...
        <tr>
            <td colspan="4">
                <div align="center" style="font-size:22px">Envio <?php echo $numero_factura; ?></div>
                <div align="center"><?php echo $fecha_factura . ' ' . $hora_factura; ?><br></div>
                <div align="left">Cliente: <?php echo $factura_cliente; ?></div>
                <div align="left">Nit: <?php echo $nit_cliente; ?><br></div>
                <div align="left">Direccion: <?php echo $dir; ?><br></div>
...
while ($row = mysqli_fetch_array($sql)) {
    ...
    <tr>
        ...
        <?php if($mostrar==1){ ?>
            <td><?php echo $simbolo_moneda . ' ' . number_format($precio_venta, 2); ?></td>
...
<tr>
<td colspan="4"> FECHA:___________________________________</td>
</tr>
<tr>
<td colspan="4"></td>
</tr>
<tr>
<td colspan="4"> RECIBE:___________________________________</td>
</tr>
<tr>
<td colspan="4"></td>
</tr>
<tr>
<td colspan="4"> DPI:______________________________________</td>
</tr>
<tr>
<td colspan="4"></td>
</tr>
<tr>
<td colspan="4"> FIRMA:____________________________________</td>
</tr>
