										...
										<div class="col-lg-8">
											<div class="card-box">
												...
												<div class="widget-chart">
													<div id="resultados_ajaxf" class='col-md-12' style="margin-top:10px"></div>
													<form class="form-horizontal" role="form" id="barcode_form">
														<div class="form-group row">
															<div class="col-md-3">
															<select id="cotizacion" class='form-control select2' onchange="load();">
																<option value="">--Cotizaciones Pendientes--</option>
																	<?php
																		$sql1 = mysqli_query($conexion, "select * from tbcotizacion where estado=0;");
    																	while ($rw1 = mysqli_fetch_array($sql1)) {
        																		?>
																			<option value="<?php echo $rw1['idcotizacion'] ?>"><?php echo $rw1['cliente'].' '.$rw1['fecha']; ?></option>
																		<?php
																		}
    																	?>
												</select>
															</div>
															<label for="canti2" class="col-md-1 control-label">Cant:</label>
															<div class="col-md-2">
															<input type="text" class="form-control" autocomplete="off" id="canti2" name="canti2" >
															</div>
															<label for="condiciones" class="control-label">Codigo :</label>
															<div class="col-md-2" align="left">
																<div class="input-group">
																	<input type="text" class="form-control" id="codigo" autocomplete="off"  tabindex="1" autofocus="true" >
																</div>
															</div>
															<div class="col-md-2">
...
<script type="text/javascript" src="../../js/cotizacion_escuela.js"></script>
<script>
	$(function() {
	...
	$("#canti2").keydown( function(e) 
	{
    if(e.which == 13) {
        
        e.preventDefault();
		var cantidad = $("#canti2").val();
    	var idcoti=$("#cotizacion").val();
    	console.log(cantidad);
    	console.log(idcoti);       

		$.ajax({
            type: 'GET',
            url: '../ajax/update_cantidad_coti.php',
            data: "cantidad=" + cantidad+"&idcoti"+idcoti,// + "&param2=" + param2,
