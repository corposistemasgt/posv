...
<script>
	function reporte(){
		var range=$("#range").val();
		var employee_id=$("#employee_id").val();
		VentanaCentrada('../pdf/documentos/rep_egreso.php?range='+range+'&employee_id='+employee_id,'Reporte','','800','600','true');
	}
	function reporte_excel(){
		var range=$("#range").val();
		var estado_factura=$("#estado_factura").val();
		var employee_id=$("#employee_id").val();
		window.location.replace("../excel/rep_egresos.php?range="+range+"&employee_id="+employee_id);
}
</script>
