...
$('.daterange').daterangepicker({
  ...
  opens: "right"
   ...
   function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
      url:'../ajax/rep_cierres_users.php',
      data: parametros,
...
<script>
  function reporte(){
    ...
    var employee_id=$("#employee_id").val();
    VentanaCentrada('../pdf/documentos/rep_cierres_users.php?daterange='+daterange+"&employee_id="+employee_id,'Reporte','','800','600','true');
  }
</script>
