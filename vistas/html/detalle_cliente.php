							...
							<div class="portlet-body">
								<form class="form-horizontal" role="form" id="datos_cotizacion">
									<div class="form-group row">
										<input hidden value="<?php echo $idcliente; ?>" name="idcliente" id="idcliente"/>
											<div class="col-md-3">
												<span id="loader"></span>
											</div>
											<div class="col-md-12">
...
<script>
  function reporte(){
    ...
    VentanaCentrada('../pdf/documentos/rep_cxrd.php?idcliente='+idcliente,'Reporte','','800','600','true');
  }
  function reporte_excel(){
	var idcliente=$("#idcliente").val();
	window.location.replace("../excel/rep_cxrd.php?idcliente="+idcliente);
}
</script>
	<script>
